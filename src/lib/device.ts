...
import {CreateDeviceProps,registerDevice as $$registerDevice,findDeviceByDeviceId,updateDevice,findDeviceById,findDeviceByToken,deleteDevice as $$deleteDevice,getDevicesWithExpiredTokens,resetTokens,getAllTokens} from  '../db/ops/device'
import type {DeviceDocument,ApplicationDocument} from '../db/models'
import {DeviceAlreadyRegisteredError,TokenAliveError,NoDeviceWithToken,ApplicationNotFoundError,AlreadySubscribedError,SubscriptionNotFoundError} from './errors'
...
import { findApplicationById,getApplicationsFromSubscriptionNames ,addSubscrptionNametoApplication,removeSubscriptionNameFromApplication} from './application'
...
export const removeDeviceSubscriber = async(deviceMongoId:DeviceDocument['id'],subscriptionName:string):Promise<{id:DeviceDocument['id'],subscriptions:ApplicationDocument[]}> =>{
